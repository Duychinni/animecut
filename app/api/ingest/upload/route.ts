...
export async function POST(req: Request) {
  try {
    ...
    return NextResponse.json({
      ...
      bucket: target.bucket,
      objectPath: target.objectPath,
      uploadUrl: 'uploadUrl' in target ? target.uploadUrl : null,
      method: 'method' in target ? target.method : null,
      headers: 'headers' in target ? target.headers : null,
      uploadId: 'uploadId' in target ? target.uploadId : null,
      partSize: 'partSize' in target ? target.partSize : null,
      partUrl: 'partUrl' in target ? target.partUrl : null,
      completeUrl: 'completeUrl' in target ? target.completeUrl : null,
      contentType,

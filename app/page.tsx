      ...
      <div className="mx-auto max-w-6xl px-6 py-6">
        <header className="flex items-center justify-between border-b border-white/10 pb-4">
          <Link href="/" className="flex items-center gap-2" aria-label="Go to ClipSpark home" prefetch={false}>
            <div className="grid h-8 w-8 place-items-center rounded-full bg-white/90 font-bold text-black">C</div>
            <span className="text-lg font-semibold tracking-tight">ClipSpark</span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            {userLabel ? (
              <>
                <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-2.5 py-1 text-xs font-semibold text-white/85">
        ...
        <section className="mx-auto mt-16 max-w-6xl text-center">
          <p className="text-sm font-extrabold tracking-[0.2em] text-[#39FF14] drop-shadow-[0_0_10px_rgba(57,255,20,0.85)] md:text-base">#1 AI SHORTS TOOL</p>
          <h1 className="mt-4 text-4xl font-bold leading-tight md:text-6xl">Turn one long video into multiple viral-ready clips.</h1>
          <p className="mx-auto mt-4 max-w-2xl text-white/70">
            Paste a link or upload a file to instantly test transcript scoring, hook-first ranking, and short-form clip ideas.
          </p>

          <div className="mx-auto mt-8 w-full max-w-3xl rounded-2xl border border-white/15 bg-white/5 p-4 md:p-5">
            <div className="mx-auto flex w-full max-w-3xl items-center gap-2 rounded-2xl border border-white/15 bg-black/35 p-2">
        ...
        <section id="features" className="mt-14 grid gap-4 md:grid-cols-3">
          {[
            ...
            <article key={title} className="rounded-xl border border-white/10 bg-white/[0.03] p-4 text-left">
        ...
        <section id="how-it-works" className="mb-8 mt-10 rounded-xl border border-white/10 bg-white/[0.03] p-4 text-sm text-white/70">

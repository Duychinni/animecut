...
- Heavy export jobs may time out on low-tier serverless plans (consider queue worker for scale)
...
4. Deploy
5. Update Supabase Auth Site URL + redirect URL to your production domain
